...
const SERENITY_TEXTS = [
  "In the quiet moments, we find our true selves.",
  "Peace comes from within. Do not seek it without.",
  "The present moment is filled with joy and happiness.",
  "Let your mind be as a mirror, reflecting all, holding nothing.",
  "In stillness, we find the answers we seek.",
];

export default function SerenityGame() {
  ...
  useEffect(() => {
    if (!state.isPlaying) {
      const randomText = SERENITY_TEXTS[Math.floor(Math.random() * SERENITY_TEXTS.length)];
      dispatch({ type: 'START_GAME', payload: { mode: 'serenity', text: randomText } });
